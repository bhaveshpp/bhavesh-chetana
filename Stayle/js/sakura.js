...
var Sakura = function Sakura(selector, options) {
  ...
  var defaults = {
    ...
    gradientColorStart: 'rgba(0, 183, 197, 0.9)',
    // Gradient color start (rgba).
    gradientColorEnd: 'rgba(0, 197, 208, 0.9)',
    // Gradient color end (rgba).
    gradientColorDegree: 90 // Gradient degree angle.
  ...
  // this.el.style.overflow = 'hidden'; // Random array element
